...
Dodajemy nową aplikację na https://dashboard.heroku.com/apps[Dashboard] lub
na konsoli.
...
Ostrzeżenia powyżej sugerują, że warto też dodać wersję Ruby do pliku _Gemfile_:
...
https://github.com/doabit/bootstrap-sass-extras[bootstrap-sass-extras] czy nie?*
